 ...
 **/
#if TARGET_IPHONE_SIMULATOR && DISPLAY_DETAILS
...
function:fnct                                       \
line:__LINE__                                       \
functionStr: HOGetMethodCallWithArguments(&self, _cmd, (char *)__PRETTY_FUNCTION__)     \
...
function:fnct                                        \
line:__LINE__                                        \
functionStr:[NSString stringWithFormat:@"%s", __PRETTY_FUNCTION__]     \
format:(frmt), ##__VA_ARGS__]
